...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        /*
         * Livewire's own default is max:12288 (12 MB), and it is checked
         * before a Filament field's maxSize() is ever consulted — so a 40 MB
         * package video was being rejected with no useful message, whatever
         * the upload field claimed to allow.
         *
         * Raised here to cover video. Individual fields still set their own
         * lower limits (package photos stay at 8 MB), so this is a ceiling,
         * not a target. The server's upload_max_filesize / post_max_size are
         * a separate, usually lower cap — see DEPLOY.md.
         */
        'rules' => ['required', 'file', 'max:' . env('LIVEWIRE_UPLOAD_MAX_KB', 102400)],
        ...
        // Five minutes is not long for a 50 MB video on a Tanzanian
        // connection; the upload is invalidated mid-transfer if it overruns.
        'max_upload_time' => (int) env('LIVEWIRE_UPLOAD_MAX_MINUTES', 20),
